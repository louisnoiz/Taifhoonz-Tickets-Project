<template>
  <div class="container mx-auto">
    <div
      class="grid grid-rows gap-4 border rounded-xl drop-shadow-lg border-[#c33838] px-20 mt-2"
    >
      <div class="flex py-8">
        <div class="w-1/2">
          <div class="flex flex-col items-center">
            ...
            <img
              class="w-80 object-cover rounded-lg mt-8"
        ...
        <div class="w-1/2 px-8">
          <div class="py-4 mt-4">
            ...
            <p class="text-gray-700 mt-8">
              ...
              รอบที่ 1 เวลา 14.00 THE SUN ☀️ ETC. | JEFF SATUR | HYBS
              “ผู้จุดประกาย คือแสงที่สาดส่องไปยังทุกแห่งหน จนเกิดเป็นความสดใส
              ความสุข ความสำเร็จ” รอบที่ 2 เวลา 17.30
            </p>
          </div>
          <div class="relative inline-block text-left">
            <div>
              ...
              <div v-show="isOpen"
                class="right-0 mt-2 w-full rounded-md shadow-lg bg-red-500 ring-1 ring-black ring-opacity-5 "
                role="menu"
                aria-orientation="vertical"
                aria-labelledby="rounds-menu"
              >
        ...
        class="selectZoneBtn mb-4 px-4 py-2 bg-red-500 text-white font-bold rounded hover:bg-red-600"
        >Select Zone -></router-link
      >
    </div>
  </div>
</template>
